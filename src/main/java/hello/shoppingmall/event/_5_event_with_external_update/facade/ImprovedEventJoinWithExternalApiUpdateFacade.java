package hello.shoppingmall.event._5_event_with_external_update.facade;

import hello.shoppingmall.event._3_event_with_lock.entity.EventWithLockParticipant;
import hello.shoppingmall.event._4_event_with_external.external.ExternalEventApi;
import hello.shoppingmall.event._4_event_with_external.external.model.ExternalEventResponse;
import hello.shoppingmall.event._4_event_with_external.service.EventExternalUpdateService;
import hello.shoppingmall.event._5_event_with_external_update.event.EventJoinCompletedEvent;
